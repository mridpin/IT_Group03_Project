...
/**
 * Jersey REST client generated for REST resource:AdministradoresFacadeREST
 * [model.pojos.administradores]<br>
 * USAGE:
 * <pre>
 ...
 * @author ridao
 */
public class AdministradoresJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/Whiteboard_REST/webresources";

    public AdministradoresJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("model.pojos.administradores");
    }
