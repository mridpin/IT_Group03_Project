...
/**
 * Jersey REST client generated for REST resource:AulasFacadeREST
 * [model.pojos.aulas]<br>
 * USAGE:
 * <pre>
 ...
 * @author ridao
 */
public class AulasJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/Whiteboard_REST/webresources";

    public AulasJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("model.pojos.aulas");
    }
