...
/**
 * Jersey REST client generated for REST resource:ProfesoresFacadeREST
 * [model.pojos.profesores]<br>
 * USAGE:
 * <pre>
 ...
 * @author Portatil
 */
public class ProfesoresJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/Whiteboard_REST/webresources";

    public ProfesoresJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("model.pojos.profesores");
    }
